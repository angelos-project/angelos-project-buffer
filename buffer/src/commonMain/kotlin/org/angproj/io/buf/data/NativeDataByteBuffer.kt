...
/**
 * A common expect class for the non-mutable data-buffer that is allocated in native memory on the outside of the heap.
...
) : AbstractDataBuffer, ImmutableNativeDataBuffer