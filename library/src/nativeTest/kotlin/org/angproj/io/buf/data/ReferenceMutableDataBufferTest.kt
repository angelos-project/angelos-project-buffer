...
class ReferenceMutableDataBufferTest : MutableDataBufferTest() {
    ...
    fun testReferenceMutableBuffer() {
        testMutableDataBufferRead(refMutableDataBufferOf(populateNativeByteArray(createArray())))
        testMutableDataBufferWrite(refMutableDataBufferOf(createArray()))
        testMutableDataBufferWriteReverse(refMutableDataBufferOf(createArray()))
    }
