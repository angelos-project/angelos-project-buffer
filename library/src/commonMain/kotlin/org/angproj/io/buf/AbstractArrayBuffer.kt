...
public abstract class AbstractArrayBuffer<E> protected constructor(
    ...
    override fun iterator(): Iterator<E> = object: Iterator<E> {
        ...
        override fun next(): E = this@AbstractArrayBuffer[index++]
    }

    public override val indices: IntRange by lazy { 0..<limit }
    public override val lastIndex: Int = limit - 1
    ...
    public companion object Companion {
         ...
         */
        public val nullBuffer: AbstractArrayBuffer<*> by lazy { createNullBuffer() }
    }
}
