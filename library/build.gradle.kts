...
object This {
    ...
    const val longDescription = "A buffer for Angelos Project™."
    const val url = "https://github.com/angelos-project/angelos-project-buffer"
}
...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            implementation("org.angproj.sec:angelos-project-secrand:0.12.3")
...
mavenPublishing {
    ...
    pom {
        ...
        scm {
            url.set(This.url)
            connection.set("scm:git:git://github.com/angelos-project/angelos-project-buffer.git")
            developerConnection.set("scm:git:ssh://github.com:angelos-project/angelos-project-buffer.git")
        }
    }
}
